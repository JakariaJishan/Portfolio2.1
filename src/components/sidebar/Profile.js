  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="flex justify-center items-center text-xs gap-3">
        <div >
          <Link to='https://github.com/JakariaJishan' className="flex items-center gap-1 group text-gray-400 hover:text-white">
            <BsGithub />
            Github
        ...
        <div >
          <Link to='https://www.linkedin.com/in/jakariajishan/' className="flex items-center gap-1 group text-gray-400 hover:text-white">
            <BsLinkedin />
            Linkedin
            <BsArrowUpRight className="transition ease-out duration-300 group-hover:-translate-y-1 text-md " />
          </Link>
